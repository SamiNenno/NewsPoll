...
class Newscounter:
    '''
    Class for computing and saving absolute and relative mentions count for each searchterm
    in newspaper data
    '''
    def __init__(self):
    ...
    def create_search_dict(self):
        ...
        :return: dictionary of searchterms with and without genitiv s
        '''
    ...
    def count(self):
        '''
        Counts the amount of mentions for each searchterm
        '''
    ...
    def save_freq_count(self):
        '''
        Saves mentions count to csv file
        '''
    ...
    def absolute_count(self):
        '''
        Computes absolute mentions share

        :return: Amount of absolute mentions per searchterm
        '''
    ...
    def relative_count(self, who: str = "individual_politicians"):
        '''
        Computes relative mentions share in percent

        :param who: Either politician or party level
        :return: Relative mentions count in percent
        '''
    ...
    def create_relative_frame(self):
        '''
        Creates dataframes of relative mentions share

        :return: csv file of relative mentions share
        '''
    ...
    def date_casting(self, df, earliest_date:str = "06.01.2021"):
        '''
        Brings dates in right format

        :param df: Data of mentions
        :param earliest_date: Data at which counting starts. Default is 06.01.2021 because newsdata before June is sparse
        :return: dataframe of correctly parsed date
        '''
